package com.bwie.day0527_yuekaoaban.newsdrag;
...
import com.bwie.day0527_yuekaoaban.IApplication;
import com.bwie.day0527_yuekaoaban.R;
import com.bwie.day0527_yuekaoaban.newsdrag.adapter.DragAdapter;
import com.bwie.day0527_yuekaoaban.newsdrag.adapter.OtherAdapter;
import com.bwie.day0527_yuekaoaban.newsdrag.bean.ChannelItem;
import com.bwie.day0527_yuekaoaban.newsdrag.bean.ChannelManage;
import com.bwie.day0527_yuekaoaban.newsdrag.view.DragGrid;
import com.bwie.day0527_yuekaoaban.newsdrag.view.OtherGridView;
                                    ...
                                    public void onClick(DialogInterface dialog,
                                        ...
                                        switch (which){
                                            ...
                                            case 0:
                                                ...
                                                AlertDialog.Builder builder = new AlertDialog.Builder(ChannelActivity.this);
                                                // 设置参数
                                                builder.setTitle("版本更新").setIcon(R.drawable.ic_launcher)
                                                    ...
                                                    public void onClick(DialogInterface dialog,
                                                        ...
                                                        RequestParams rp = new RequestParams("http://imtt.dd.qq.com/16891/E4E087B63E27B87175F4B9BC7CFC4997.apk?fsname=com.tencent.qlauncher_6.0.2_64170111.apk&csr=97c2\"/*http://imtt.dd.qq.com/16891/6FF2E89F6710638DB43B17CE0A2D7A14.apk?fsname=com.tencent.qqpimsecure_7.0.0_1171.apk&csr=97c2*/");
                                                        ...
                                                        x.http().get(rp, new Callback.ProgressCallback<File>() {
                                                            ...
                                                            public void onSuccess(File result) {
                                                                Toast.makeText(ChannelActivity.this, "下载完成,开始安装!", Toast.LENGTH_SHORT).show();
                                                                installApk(result);
                                                            }
